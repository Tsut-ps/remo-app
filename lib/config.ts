...
export const API_ENDPOINTS = {
  ...
  light: (applianceId: string) => `${NATURE_API_BASE}/appliances/${applianceId}/light`,
  aircon: (applianceId: string) => `${NATURE_API_BASE}/appliances/${applianceId}/aircon_settings`,
  tv: (applianceId: string) => `${NATURE_API_BASE}/appliances/${applianceId}/tv`,
